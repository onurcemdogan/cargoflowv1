...
function ShipmentDefaultsSection({
  ...
  return (
    ...
    >
      ...
      {/* KARGO ETİKETİ ŞABLONU — sağlayıcıdan BAĞIMSIZ ortak ayar.
          Sürat hesabı olmasa da görünür. Mevcut CargoFlow HTML şablonu
          KALDIRILMADI; iki şablon yan yana yaşar ve varsayılan CargoFlow'dur,
          bu yüzden deploy sonrası kimsenin baskı davranışı DEĞİŞMEZ. */}
