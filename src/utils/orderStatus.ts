...
// NOT (2026-07): Yaşa dayalı 60 günlük otomatik "Arşiv" fallback'i KALDIRILDI.
// Ürün kuralı: yalnız yaşı eski olmak bir siparişi Arşiv (veya Kargoya Verildi)
// yapmaz. Arşiv YALNIZ gerçek pasif kanıtla (explicit archived / archivedAt)
// belirlenir; bu da classifyOrderForTabs.isArchived üzerinden yürür. Güçlü
// gerçek statü (delivered/shipped/cancelled/label) her zaman kullanılır; yaş
// canonical sonucu EZMEZ. Bu yüzden ayrı isHistoricalOrder helper'ı gerekmez.
